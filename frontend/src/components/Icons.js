...
export const AiBotIcon = () => (
  <img src="/logo.png" alt="AI Bot" style={{ width: '100%', height: '100%', objectFit: 'contain' }} />
);
...
export const Logo = () => (
  <img src="/logo.png" alt="Dynova Logo" style={{ width: '32px', height: '32px', objectFit: 'contain' }} />
);
...
export const ContactIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M17 18a2 2 0 0 0-2-2H9a2 2 0 0 0-2 2"></path><rect x="3" y="4" width="18" height="16" rx="2"></rect><circle cx="12" cy="10" r="3"></circle>
  </svg>
);
...
export const InstructionIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <line x1="4" y1="9" x2="20" y2="9"></line><line x1="4" y1="15" x2="20" y2="15"></line><line x1="10" y1="3" x2="10" y2="21"></line><line x1="16" y1="3" x2="16" y2="21"></line>
  </svg>
);
